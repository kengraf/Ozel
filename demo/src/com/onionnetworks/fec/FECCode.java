 package com.onionnetworks.fec;
        ...
        public abstract class FECCode {
             ...
             */
            protected abstract void encode(byte[][] src, int[] srcOff,
                    byte[][] repair, int[] repairOff, int[] index,
                    int packetLength);
             ...
             * byte[][] is wrapping an underlying byte[] then the shuffling procedure
            ...
            protected abstract void decode(byte[][] pkts, int[] pktsOff,
                    int[] index, int packetLength, boolean shuffled);
            ...
            public void encode(Buffer[] src, Buffer[] repair, int[] index) {
                ...
                encode(srcBufs, srcOffs, repairBufs, repairOffs, index,
                        src[0].len);
            }
             ...
             * Buffer[].
             */
            protected static final void copyShuffle(Buffer[] pkts, int index[],
                    int k) {
                byte[] b = null;
                for (int i = 0; i < k;) {
                    if (index[i] >= k || index[i] == i) {
                        ...
                        System
                                .arraycopy(pkts[i].b, pkts[i].off, b, 0,
                                        b.length);
                        System.arraycopy(pkts[c].b, pkts[c].off, pkts[i].b,
                                pkts[i].off, b.length);
                        System
                                .arraycopy(b, 0, pkts[c].b, pkts[c].off,
                                        b.length);
                    }
                }
            }
