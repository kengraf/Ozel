  package com.onionnetworks.fec;
        ...
        public class DefaultFECCodeFactory extends FECCodeFactory {
            ...
            private static Logger logger = Logger
                    .getLogger(DefaultFECCodeFactory.class.getName());
            ...
            public DefaultFECCodeFactory() {
                ...
                try {
                    ...
                    logger.log(Level.SEVERE,
                            "Unable to load /lib/fec.properties", e);
                ...
                while (st.hasMoreTokens()) {
                    ...
                    try {
                        Constructor con = Class.forName(
                                getProperty("com.onionnetworks.fec." + key
                                        + ".class")).getConstructor(
                                new Class[] { int.class, int.class });
                        String numBits = getProperty("com.onionnetworks.fec."
                                + key + ".bits");
                        if ("8".equals(numBits)) {
                        ...
                        logger.log(Level.SEVERE,
                                "Exception thrown in constructor", t);
                    }
                }
            }
            ...
            public synchronized FECCode createFECCode(int k, int n) {
                ...
                if (result == null) {
                    ...
                    while (it.hasNext()) {
                        try {
                            result = (FECCode) ((Constructor) it.next())
                                    .newInstance(new Object[] { K, N });
                            break;
                        } catch (Throwable doh) {
                            //doh.printStackTrace();
                        }
